...
<?
		...
		$inicial = ($pg_num * $reg_num);
			...
			$regs = mysql_query("SELECT * FROM ".$navega." WHERE vaga = '$vaga' ORDER BY candidato LIMIT $inicial,$reg_num");		
...
?>
	...
	if(mysql_num_rows($regs)==0)
        ...
        <tr>
          <td colspan="3" align="center"><br>
			...
			<?
			$regs = mysql_query("SELECT * FROM vagas ORDER BY titulo");			
	...
	while ($reg = mysql_fetch_array($regs)){
		...
		$regs2 	= mysql_query("SELECT * FROM curriculo WHERE codigo='$candidato'");			
