...
########################################################################
$quota_limit = 256000;  //  in KB, eg. 4096 Kb = 4MB
...
$mail_servers[] = Array( //sample using POP3
	"domain" 		=> "conhecerconsultoria.com", 
	"server" 		=> "localhost", 
...
$default_mail_server 	= "mail.conhecerconsultoria.com";
...
Mensagem enviada usando $appname $appversion. Powered by: mkinformatica.net
";
...
$default_preferences = Array(
	...
	"timezone_default"			=> "-0300",	# timezone, format (+|-)HHMM (H=hours, M=minutes)
