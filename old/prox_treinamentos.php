...
<table width="711" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <p align="center" class="texto_verde">Treinamento Norma    Regulamentadora N&ordm; 10<br />
Seguran&ccedil;a em    Instala&ccedil;&otilde;es e Servi&ccedil;os em Eletricidade<br />
M&oacute;dulo B&aacute;sico -    40hs</p>
    <p align="center"><a href="Conteudo_Programatico.doc" target="_blank"> Progra</a><br />
      <strong> PRÓXIMOS TREINAMENTOS PREVISTOS </strong><br />
      Setembro/Outubro    2007</p>
    <table cellspacing="0" cellpadding="0" border="1">
        ...
        <col width="131" />
        <tr height="17">
          <td height="17" colspan="5" align="center"><div align="center"><b>Turma 1</b></div></td>
        </tr>

        <tr height="17">
          <td width="106" height="17" align="center" bgcolor="#e6e6e6"><div align="center"><strong>15/set</strong></div></td>
          <td width="93" align="center" bgcolor="#e6e6e6"><div align="center"><strong>22/set</strong></div></td>
          <td width="93" align="center" bgcolor="#e6e6e6"><div align="center"><strong>29/set</strong></div></td>
          <td width="84" align="center" bgcolor="#e6e6e6"><div align="center"><strong>6/out</strong></div></td>
          <td width="92" align="center" bgcolor="#e6e6e6"><div align="center"><strong>20/out</strong></div></td>
        </tr>
        <tr height="17">
          <td colspan="5" height="17"><div align="center">Manh&atilde; - 4 hs</div></td>
        </tr>
        <tr height="17">
          <td height="17">Eletricidade</td>
          <td>Eletricidade</td>
          <td>Combate Inc&ecirc;ndio</td>
          <td>Seguran&ccedil;a</td>
          <td>Primeiros Socorros</td>
        </tr>
        <tr height="17">
          <td colspan="5" height="17"><div align="center">Tarde - 4 hs</div></td>
        </tr>
        <tr height="17">
          <td height="17">Seguran&ccedil;a</td>
          <td>Eletricidade</td>
          <td>Combate Inc&ecirc;ndio</td>
          <td>Seguran&ccedil;a</td>
          <td>Primeiros Socorros</td>
        ...
        <tr height="17">
          <td colspan="5" height="17"><div align="center"><strong>Turma 2</strong></div></td>
        </tr>

        <tr height="17">
          <td height="17" align="right" bgcolor="#e6e6e6"><div align="center"><strong>15/set</strong></div></td>
          <td align="right" bgcolor="#e6e6e6"><div align="center"><strong>22/set</strong></div></td>
          <td align="right" bgcolor="#e6e6e6"><div align="center"><strong>29/set</strong></div></td>
          <td align="right" bgcolor="#e6e6e6"><div align="center"><strong>6/out</strong></div></td>
          <td align="right" bgcolor="#e6e6e6"><div align="center"><strong>20/out</strong></div></td>
        </tr>
        <tr height="17">
          <td colspan="5" height="17"><div align="center">Manh&atilde; - 4 hs</div></td>
        </tr>
