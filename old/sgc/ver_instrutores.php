...
<div class="content"><h2 align="left"><img src="images/le_instrutores.gif" width="377" height="28"></h2>
<hr>
  ...
  <tr>
      ...
      <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" class="txt-cinza02">                
        ...
        <?		$navega = $_GET["navega"];
                ...
                $inicial = ($pg_num * $reg_num);
                    $regs = mysql_query("SELECT * FROM instrutores ORDER BY id desc LIMIT $inicial,$reg_num");
                    $contador01 = "SELECT * FROM instrutores ORDER BY id desc";					
    ...
    ?>
            ...
            <tr bgcolor="#FF9900">
              ...
              <td width="81" align="center">Registro Profissional</td>              
              <td width="153" align="center">Forma&ccedil;&atilde;o</td>
              <td width="83" align="center">Exp. Instrutor</td>
              </tr>
            <tr> 
        ...
        while ($reg = mysql_fetch_array($regs)){
            ...
            $nome 	 = $reg["nome"];            
            $cpf	 = $reg["CPF"];
			$ref_prof = $reg["ref_prof"];
            $formacao  = $reg["formacao"];
            $exp_instrutor  = $reg["exp_instrutor"];
            ?>
            <tr>
              <td align="center" class="<? print $td;?>"><a href="principal.php?navega=3&ii=<?=$n?>"><img src="images/icon_view.gif" width="15" height="15" border="0" alt="Visualizar processo n&ordm; <?=$n?>"></a>  <a href="principal.php?navega=6&np=<?=$n?>"></a><a href='principal.php?navega=8&np=<?=$n?>'></a></td>
              <td align="center" class="<? print $td;?>"><b><? print $n; ?></b></td>
              <td align="left" class="<? print $td;?>"><b><? print $nome; ?></b></td>
              <td class="<? print $td;?>" align="center"><? print $cpf; ?></td>
              <td align="left" class="<? print $td;?>"><? print $ref_prof; ?></td>
              <td align="left" class="<? print $td;?>"><? print $formacao; ?></td>
              <td align="center" class="<? print $td;?>"><? print $exp_instrutor; ?></td>
              </tr>
            <tr>
