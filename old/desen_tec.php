...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0','width','709','height','33','align','middle','src','flash/menu','quality','high','pluginspage','http://www.macromedia.com/go/getflashplayer','movie','flash/menu' ); //end AC code
  ...
  <tr>
    ...
    <td width="500"><div class="divcentro">
      <p align="justify">O aprimoramento t&eacute;cnico dos profissionais &eacute; um  processo cont&iacute;nuo, que n&atilde;o se esgota com a simples realiza&ccedil;&atilde;o de um curso, uma  vez que o mercado est&aacute; em constante mudan&ccedil;a. Para n&atilde;o desperdi&ccedil;ar os recursos  voltados para o desenvolvimento t&eacute;cnico, &eacute; imprescind&iacute;vel que a empresa e seus  setores tenham uma vis&atilde;o clara de que compet&ecirc;ncias t&eacute;cnicas precisam ser  adquiridas ou aperfei&ccedil;oadas.</p>
      <p align="justify">        T&atilde;o importante como identificar quais s&atilde;o as  compet&ecirc;ncias a serem desenvolvidas &eacute; saber se o contexto permite absorver o  novo conhecimento em tempo suficiente para que o mesmo n&atilde;o se torne obsoleto.</p>
      <p align="justify">A Conhecer conta com  profissionais aptos a desenvolver o aperfei&ccedil;oamento t&eacute;cnico em v&aacute;rias &aacute;reas,  identificando a melhor forma de implementar o conhecimento, garantindo  resultados mensur&aacute;veis.</p>
    </div></td>
  </tr>
  <tr>
