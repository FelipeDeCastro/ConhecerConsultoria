...
if($_GET['logar'] == 1){		
		$regs= mysql_query("SELECT * FROM curriculo WHERE codigo =". $_SESSION["sess_codigo"], $db_conn);
...
<table align="center" border='0' width=685 cellpadding='4'>
  <tr>
    <td colspan=2 align='left' class="titulo">Sindimest/RJ</td>
  </tr>
</table>
<table align="center" border='0' width=685 cellpadding='4' class="texto">
  <tr>
    <td width="26%" class="td3"><span class="texto2"> </span>Como teve conhecimento do Sindimest/RJ:</td>
    <td class="td2">
