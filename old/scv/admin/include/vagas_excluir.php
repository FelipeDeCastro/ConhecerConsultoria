...
<table width="400"  border="0" align="center" cellpadding="0" cellspacing="2" class="td-cinza04">
  ...
  <tr> 
    ...
    <td colspan=2><input name="titulo" disabled type="text" class="input-A" id="titulo" value="<? echo $titulo; ?>" size="40" maxlength="100"></td>
  </tr>
  <tr> 
    <td align="right" class="txt-cinza02">Requisitos</td>
    <td colspan=2><textarea name="requisitos" cols="40" rows="4" disabled="disabled" wrap="VIRTUAL" class="input-A" id="requisitos"><? echo $requisitos; ?></textarea></td>
  </tr>
  <tr> 
