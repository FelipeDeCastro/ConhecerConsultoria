...
<?
		...
		$inicial = ($pg_num * $reg_num);
			...
			$regs = mysql_query("SELECT * FROM ".$navega." ORDER BY codigo DESC LIMIT $inicial,$reg_num", $db_conn);		
...
?>
          ...
          <td width="50%" class="td-cinza04"><a href="./?navega=<? echo $navega; ?>_incluir" class="link-cinza02">Incluir 
            vaga</a><br>
...
?>
        ...
        <tr>
          ...
          <td width="50" align="center" class="td-cinza01"><strong>A&Ccedil;&Atilde;O</strong></td>
        </tr>
        <tr> 
	...
	while ($reg = mysql_fetch_array($regs)){
        ...
        <tr>
          ...
          <td width="1" align="center"></td>
          <td align="center" class="<? print $td;?>"><a href="./?navega=vagas_editar&codigo=<? print $codigo; ?>"><img src="images/icon_editar.gif" alt="Editar" width="15" height="15" border="0"></a>&nbsp;<a href="./?navega=vagas_excluir&codigo=<? print $codigo; ?>"><img src="images/icon_deletar.gif" alt="Excluir" width="15" height="15" border="0"></a></td>
		</tr>
        <tr>
