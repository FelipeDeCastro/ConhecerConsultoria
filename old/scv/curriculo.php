...
<html>
<head>
<title> Cadastro de novo Currículo - <? echo date(Y); ?></title>
<style type="text/css">
...
<tr>
	<td align='center' class="titulo2">
			<p><img border="0" src="images/topo_cad.jpg"></img><strong><br>
					Para ter acesso as vagas cadastradas, cadastre </strong><strong> seu currículo. </strong><br>
					Para incluir o seu currículo em nosso banco de dados é necessário que complete os dados do formulário abaixo: </p>
			</td>
</TR></table>
<br>
<table align="center" border='0' width=685 cellpadding='4'>
...
<tr>
  ...
  <td class="td2"><input name="naturalidade" type="text" class="input-a" id="naturalidade" value="" size=30 maxlength=255></td>
</tr>
<input type="hidden" name="situacao" value="#">	
<tr>
  <td class="td3">&nbsp;&nbsp;Estado:</td>
  <td class="td2"><select name="estado" class="input-a" id="estado">
                <option>Selecione</option>
          <?php	 include ("admin/db.php"); 
  			$sqlestado = "SELECT estado FROM tb_estados order by codigo";
			$categorias = mysql_query($sqlestado)
				or die ("Não foi possível consultar os estados");
			while ($linha=mysql_fetch_array($categorias)) 
			{
				$uf  	 = $linha["uf"]; 
				$nom_est = $linha["estado"];
		    print "<option value='$uf'>$nom_est</option>";
			 } 			 
		?>
            </select> 
      Pa&iacute;s: 
...
<table align="center" border='0' width=685 cellpadding='4' class="texto">
  <tr>
    ...
    <td class="td2"><input name="n_cert_militar" type="text" class="input-a" id="n_cert_militar" value="" size=25 maxlength=50>
      Esp&eacute;cie: 
      <input name="cm_especie" type="text" class="input-a" id="cm_especie" size=8 maxlength=10>
      Categoria: 
      <input name="cm_categ" type="text" class="input-a" id="cm_categ" size=8 maxlength=10> 
      UF: 
      <input name="cm_uf" type="text" class="input-a" id="cm_uf" size=5 maxlength=10></td>
  </tr>
  <tr>
    <td width="26%" class="td3"><span class="texto2">*</span>RG/RE:</td>
    <td class="td2"><input name="rg" type="text" class="input-a" id="rg" size=12 maxlength=10>
      &Oacute;rg&atilde;o 
      Exp.: 
      <input name="rg_orgao" type="text" class="input-a" id="rg_orgao" size=5 maxlength=10>
      Data Emiss&atilde;o:
      <input name="rg_emissao" type="text" class="input-a" id="rg_emissao" size=12 maxlength=10> 
      UF:      
      <input name="rg_uf" type="text" class="input-a" id="rg_uf" size=5 maxlength=10></td>
  </tr>
  <tr>
    <td width="26%" class="td3">&nbsp;&nbsp;PIS:</td>
    <td class="td2"><input name="pis" type="text" class="input-a" id="pis" size=30 maxlength=255>
Data Emiss&atilde;o:
<input name="pis_emissao" type="text" class="input-a" id="pis_emissao" size=12 maxlength=10></td>
  </tr>
  <tr>
    <td class="td3">&nbsp;&nbsp;CPF:</td>
  ...
  <tr>
    ...
    <td class="td2"><input name="eleitor" type="text" class="input-a" id="eleitor" size=20 maxlength=30>
      Zona: 
  <input name="eleitor_zona" type="text" class="input-a" id="eleitor_zona" size=5 maxlength=10>
  Se&ccedil;&atilde;o: 
  <input name="eleitor_sessao" type="text" class="input-a" id="eleitor_sessao" size=5 maxlength=10>
  Data Emiss&atilde;o: 
  <input name="eleitor_emissao" type="text" class="input-a" id="eleitor_emissao" size=5 maxlength=10>
  UF:
  <input name="eleitor_uf" type="text" class="input-a" id="eleitor_uf" size=5 maxlength=10></td>
  </tr>
  <tr>
    <td width="26%" class="td3"><span class="texto2">*</span>Cart. Habilita&ccedil;&atilde;o::</td>
    <td class="td2"><input name="cnh" type="text" class="input-a" id="cnh" size=10>
      Categoria: 	 
        <input name="cnh_categ" type="text" class="input-a" id="cnh_categ" size=5 maxlength=10>
        Registro:			
        <input name="cnh_registro" type="text" class="input-a" id="cnh_registro" size=5 maxlength=10>
        Data Emiss&atilde;o: 
        <input name="cnh_emissao" type="text" class="input-a" id="cnh_emissao" size=12 maxlength=12></td>
  </tr>
  <tr>
    <td width="26%" class="td3"><span class="texto2">*</span>CTPS:</td>
    <td class="td2"><input name="ctps" type="text" class="input-a" id="ctps" size=10>
      S&eacute;rie: 
      <input name="ctps_serie" type="text" class="input-a" id="ctps_serie" size=5 maxlength=10>
      Data Emiss&atilde;o: 
      <input name="ctps_emissao" type="text" class="input-a" id="ctps_emissao" size=12 maxlength=12>
      UF: 
      <input name="ctps_uf" type="text" class="input-a" id="ctps_uf" size=5 maxlength=10></td>
  </tr>
  <tr>
    <td width="26%" class="td3"><span class="texto2">*</span>&Oacute;rg&atilde;o Profissional N&ordm;:</td>
    <td class="td2"><input name="orgao_prof" type="text" class="input-a" id="orgao_prof" size=10>
      Nome: 
        <input name="org_prof_nome" type="text" class="input-a" id="org_prof_nome" size=30>
        Sigla: 
        <input name="org_prof_sigla" type="text" class="input-a" id="org_prof_sigla" size=5 maxlength=10>
        UF:
        <input name="org_prof_uf" type="text" class="input-a" id="org_prof_uf" size=5 maxlength=10></td>
  </tr>
</table>
<br>
<table align="center" border='0' width=685 cellpadding='4'>
...
<tr>
	...
	<td class="td2"> (<input name="telefoneDDD" type="text" class="input-a" value="<? echo $telefoneDDD; ?>" size=3 maxlength=3>) -
		<input name="telefone" type="text" class="input-a" value="<? echo $telefone; ?>" size=8 maxlength=8>
...
Falar com:
  <input name="recadopessoa" type="text" class="input-a" id="recadopessoa" value="<? echo $recado; ?>" size=40 maxlength=100></td>
</tr>
<tr>
	...
	-	<input name="celular" type="text" class="input-a" value="<? echo $celular; ?>" size=8 maxlength=8>
...
<table align="center" border='0' width=685 cellpadding='4' class="texto">
  ...
  <tr>
    ...
    <td class="td2"><select name="estado_res" class="input-a" id="select">
      <option>Selecione</option>
      <?php	 include ("admin/db.php"); 
  			$sqlestado = "SELECT estado FROM tb_estados order by codigo";
			$categorias = mysql_query($sqlestado)
...
<table align="center" border='0' width=685 cellpadding='4' class="texto">
  ...
  <tr>
    ...
    <td class="td2"><input name="acessi_tipo" type="text" class="input-a" id="acessi_tipo" value="<? echo $recado; ?>" size=40 maxlength=100></td>
  </tr>
</table>
<br>
<table align="center" border='0' width=685 cellpadding='4' class="texto">
  ...
  <tr>
    ...
    <td colspan=3 class="td2"><input name="formacao_municipio" type="text" class="input-a" id="rg_emissao3" size=40>
UF:
  <input name="formacao_uf" type="text" class="input-a" id="formacao_uf" size=5 maxlength=10></td>
  </tr>
</table>
<br>
<table align="center" border='0' width=685 cellpadding='4'>
...
Outro, especifique: </td>
    <td colspan="3" class="td2"><input name="idiomaoutro_nome" type="text" class="input-a" id="idiomaoutro_nome" size=40></td>
    </tr>
</table>
<br>
<table align="center" border='0' width=685 cellpadding='4'>
...
<table width="685" border="0" cellspacing="1" cellpadding="4" align="center" class="texto">
  ...
  <tr>
    <td class="td3"><input name="info_outro" type="checkbox" id="info_outro" value="1"<? if($italiano!=""){echo" checked";} ?>>
      Outro, especifique: </td>
    <td colspan="3" class="td2"><input name="info_outro_nome" type="text" class="input-a" id="info_outro_nome" size=40></td>
  </tr>
</table>
<br>
<table align="center" border='0' width=685 cellpadding='4'>
